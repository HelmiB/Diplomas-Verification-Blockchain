...
class Dashboard extends React.Component {
  state = {
    ...
    logo:
      "https://i.ibb.co/h94xypm/134663835-154116216509145-9179712154365388698-o.png"
  };
  ...
  render() {
    ...
    const tooltipInfo = `This verifies whether the diploma is secured and stored with correct information in the blockchain`;
    return (
